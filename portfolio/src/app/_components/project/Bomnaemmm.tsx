  ...
  return (
    <ul className="mt-2 text-center">
      <li className="mt-3">
        ...
        {openIndexes[0] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            ...
            하였습니다.
            <Image className="max-w-[600px]" src={withdraw} alt="withdraw" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[4] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={scroll} alt="scroll" width={0} height={0} />
            Firestore에 맛집 데이터를 저장해주었습니다. 음식점의 경우 place_id를 1000번, 카페의 경우 place_id를
            2000번대로 저장하였습니다. <br />
            IntersectionObserver을 이용하여 무한스크롤을 구현하였으며, Firesotre의 query를 통해 음식점/카페를 구분하여
            출력하도록 설계하였습니다. <br />
            <Image className="max-w-[600px]" src={filter} alt="filter" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[5] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={like} alt="like" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[7] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={navermap} alt="navermap" width={0} height={0} />
            데이터에 저장된 주소를 네이버 geocode을 통해 좌표로 변환한 뒤, 네이버 MAP API에 해당 값을 전달하여 해당
            위치를 마커와 함께 표시하였습니다.
            <Image className="max-w-[600px]" src={blogsearch} alt="blogsearch" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[8] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={search} alt="search" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[9] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={request} alt="request" width={0} height={0} />
