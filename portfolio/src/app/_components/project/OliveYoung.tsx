  ...
  return (
    <ul className="mt-2 text-center">
      <li className="mt-3">
        ...
        {openIndexes[0] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={header} alt="header" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[1] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={mainSlide} alt="mainSlide" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[2] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={recommend} alt="recommend" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[3] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={hot} alt="hot" width={0} height={0} />
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[4] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={brand} alt="brand" width={0} height={0} />
            next와 prev 버튼을 custom 하여 동작시켰으며, drag를 이용해 전환시킬 수 있습니다. <br /> paging을 custom 하여
      ...
      <li className="max-w-[600px]">
        ...
        {openIndexes[5] && (
          <div className="w-[800px] py-2 px-10 bg-gray-100 border flex flex-col items-center justify-center text-sm">
            <Image className="max-w-[600px]" src={top10} alt="top10" width={0} height={0} />
