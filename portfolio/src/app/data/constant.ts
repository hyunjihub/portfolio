import axios from '/public/project/tech/axios.svg';
...
import typescript from '/public/project/tech/ts.svg';
import vercel from '/public/project/tech/vercel.svg';
import vite from '/public/project/tech/vite.svg';
import zustand from '/public/project/tech/zustand.svg';

export const PROJECT_IMG = {
  용감한원정대: brave,
  '봄내음 (Bomnae-mmm)': bomnaemmm,
  '올리브영 클론코딩': oliveyoung,
  REACT_SHOP: shop,
  '별별스토어 (BYBL)': bybl,
  더취페이: dutchie,
};
